...
5. **Sort order**: `web-frontend/src/hooks/schedulingPreferenceOrdering.ts:102`
   has `typeOrder = [AT_MOST_ONE_SHIFT_PER_DAY, SHIFT_TYPE_REQUIREMENT,
   SHIFT_REQUEST, SHIFT_TYPE_SUCCESSIONS, SHIFT_COUNT, SHIFT_AFFINITY]` — does
...
describe the closed behavior (with file:line citations to the new tests)
