...
| C3 — Preference / Constraint Semantics | CON-SEM | The six preference types, weight/hard-vs-soft math, group/keyword/date-shorthand resolution, validation error catalog. |
