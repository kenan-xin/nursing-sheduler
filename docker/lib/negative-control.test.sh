...
print(json.dumps({"tests": [{
    ...
    "errorCount": 1, "expectStepCount": 1, "sawSentinel": True,
...
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "timedOut",
    "timedOut": True, "errorCount": 1, "expectStepCount": 1, "sawSentinel": True,
    "failedExpectSteps": []}]}))
PY
)"
...
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 1, "expectStepCount": 0, "sawSentinel": True,
    "failedExpectSteps": []}]}))
PY
)"
...
title, spec, step_title, message = sys.argv[1:5]
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 1, "expectStepCount": 1, "sawSentinel": False,
    "failedExpectSteps": [{"title": step_title, "file": spec, "line": 950, "message": message,
                           "terminal": True}]}]}))
PY
)"
...
title, spec, step_title, message = sys.argv[1:5]
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 2, "expectStepCount": 1, "sawSentinel": True,
    "failedExpectSteps": [{"title": step_title, "file": spec, "line": 950, "message": message,
                           "terminal": True}]}]}))
PY
)"
...
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 1, "expectStepCount": 2, "sawSentinel": True,
...
intended = {"title": step_title, "file": spec, "line": 1008, "message": message,
            "terminal": True}
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 1, "expectStepCount": 9, "sawSentinel": True,
...
retry = {"title": 'Expect "not toBeNull"', "file": spec, "line": 953,
         ...
         "terminal": False}
print(json.dumps({"tests": [{"title": title, "file": spec, "status": "failed",
    "timedOut": False, "errorCount": 1, "expectStepCount": 4, "sawSentinel": True,
