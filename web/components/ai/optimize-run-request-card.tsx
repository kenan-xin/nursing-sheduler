...
//
// A HOST CARD in the dock above the composer, like the Preview: the Run control is host state
    ...
    <DockCard
      ...
      options={
        stopped
          ...
          : [
              {
                label: opening ? "Opening…" : "Run optimiser",
                detail: "Opens the Optimise screen and starts a run.",
                primary: true,
                testId: "run-request-run",
              ...
              },
              {
                label: "Not now",
                detail: "Nothing runs.",
                testId: "run-request-dismiss",
                onPick: () => assistantActions.clearRunRequest(),
              },
            ]
      }
    >
        ...
        <>
          ...
          {failed ? (
            <p
              ...
              role="status"
              data-testid="run-request-failed"
            >
