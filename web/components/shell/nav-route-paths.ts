...
export const NAV_ROUTE_PATHS = {
  ...
  // INTEGRATION: the G4 roster viewer route. This map is a branch-introduced (T06)
  // authority that predates it, so the merged nav registry needs the binding here
  // before its entry can carry a stable `id` like every other destination.
  roster: "/roster",
