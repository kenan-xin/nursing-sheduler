...
const GOVERNED: GovernedPath[] = [
  ...
  },
  {
    ...
    acquisition: ["filesystem"],
    properties: "base",
    note: "class {4,16} -- the 16-file audited-reader class: an exact filesystem allowance and nothing else. The parser family still applies, which is the point of granting families rather than switching the rule off",
  },
  {
